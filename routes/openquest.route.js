...
//POST
router.post('/magic/:dataName',checkTokenMiddleware.checkTokenAdmin, openquestController.register); //utilisé pour remplir la base de données
...
router.delete('/character/delete/:id',checkTokenMiddleware.checkTokenAdmin, openquestController.deleteCharacter )
